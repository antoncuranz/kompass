...
const buttonVariants = cva(
  cn(
    ...
    "[&_svg:not([class*='size-'])]:size-5 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:opacity-50 [&_svg]:shrink-0 outline-none group/button select-none",
